...
{
    public partial class Encerrar_Visitas : Form
    {
        DataTable dt = new DataTable("tb_Visitas");

        conexao con = new conexao();
        public Encerrar_Visitas()
        {
            InitializeComponent();
            try
            {
            ...
            DtVisitas.Columns[7].HeaderText = "Hora De Saida";
        }
        ...
        private void DtVisitas_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Deseja Encerrar a Visita de: " + Visitantes.nome + "\nNa Casa/Apartamento do Morador: "
                    + propietario + " \nApartamento/Casa: " +
